...
bounce_snd = pygame.mixer.Sound(os.path.join(piano_path, 'bounceball.mp3'))
bye_snd = pygame.mixer.Sound(os.path.join(piano_path, 'A4_byebye.mp3'))
congratulations_snd = pygame.mixer.Sound(os.path.join(piano_path, 'congratulations.mp3'))
